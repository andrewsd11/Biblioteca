...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0004_usuario_rename_cliente_genero_delete_funcionario_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='livro',
            name='autor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.autor', verbose_name='Autor do livro'),
        ),
        migrations.AddField(
            model_name='livro',
            name='editora',
